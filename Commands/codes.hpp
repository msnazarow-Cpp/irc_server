...
#define ERR_INVALIDCHANNELNAME_MESS ":Invalid channel name"
...
#define RPL_CREATIONTIME 			"329"      // "<client> <channel> <creationtime>"
											//Sent to a client to inform them of the creation time of a channel.
											// <channel> is the name of the channel. <creationtime> is a unix timestamp 
...
#define RPL_ENDOFBANLIST_MESS		":End of channel ban list"
